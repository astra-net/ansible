...
MAIN[s0aws]="internal validator nodes in mainnet shard 0"
MAIN[s1aws]="internal validator nodes in mainnet shard 1"
MAIN[s2aws]="internal validator nodes in mainnet shard 2"
MAIN[s3aws]="internal validator nodes in mainnet shard 3"
MAIN[s0exp]="explorer nodes in mainnet shard 0"
MAIN[s0expg]="archival explorer nodes in mainnet shard 0"
MAIN[s0expm]="non-archival explorer nodes in mainnet shard 0"
MAIN[s0expm2]="another group of non-archival explorer nodes in mainnet shard 0"
MAIN[s0expm3]="regional group of non-archival explorer nodes in mainnet shard 0"
MAIN[s1exp]="explorer nodes in mainnet shard 1"
